...
%
%% Description
% The function |vmax| returns the fishery that maximizes the
...
%
function [out1,out2] = vmax(t,i,w,m)
%% Input arguments:
% * |t| = time period;
% * |i| = vessel;
...
%
%% Parameters 
A = m.model.actions;                      % Set of all possible actions
...
%% Calculate value for each fishery
    ...
    for j=1:da                                  % Loop over all possible actions
        f(:,j) = func('f',j,t,i,[],w,m); % Evaluate the reward
    end
